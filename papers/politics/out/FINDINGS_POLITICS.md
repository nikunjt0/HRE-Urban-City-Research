...
**Companion to** `papers/city_growth/out/FINDINGS.md` (which showed: geography + path
...
## Reproduce
`papers/politics/`: `build_crosswalk_cityid.py` → `classify_rulers.py` →
...
Outputs in `papers/politics/out/` (JSONs per analysis + figures/).
